...
NSPort * NSPort_allocWithZone (NSZone * zone) {
	NSLog(@"NSPort_allocWithZone");
	return [NSPort allocWithZone:zone];
}

NSPort * NSPort_port (NSPort* THIS) {
	NSLog(@"NSPort_port");
	return [THIS port];
}
...
void NSPort_setDelegate (NSPort* THIS, NSPort * anId) {
...
NSPort * NSPort_portWithMachPort (NSPort* THIS, int machPort) {
	NSLog(@"NSPort_portWithMachPort");
	return [THIS portWithMachPort:machPort];
}
