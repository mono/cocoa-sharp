...
void NSKeyValueObserving_observeValueForKeyPath_ofObject_change_context (NSKeyValueObserving* THIS, NSString * keyPath, NSKeyValueObserving * object, NSDictionary * change, void * context) {
...
BOOL NSKeyValueObserving_automaticallyNotifiesObserversForKey (NSKeyValueObserving* THIS, NSString * key) {
	NSLog(@"NSKeyValueObserving_automaticallyNotifiesObserversForKey");
	return [THIS automaticallyNotifiesObserversForKey:key];
}

void NSKeyValueObserving_setKeys_triggerChangeNotificationsForDependentKey (NSKeyValueObserving* THIS, NSArray * keys, NSString * dependentKey) {
	NSLog(@"NSKeyValueObserving_setKeys_triggerChangeNotificationsForDependentKey");
	[THIS setKeys:keys triggerChangeNotificationsForDependentKey:dependentKey];
}
