...
BOOL NSURLConnection_canHandleRequest (NSURLConnection* THIS, NSURLRequest * request) {
	NSLog(@"NSURLConnection_canHandleRequest");
	return [THIS canHandleRequest:request];
}

NSURLConnection * NSURLConnection_connectionWithRequest_delegate (NSURLConnection* THIS, NSURLRequest * request, NSURLConnection * delegate) {
	NSLog(@"NSURLConnection_connectionWithRequest_delegate");
	return [THIS connectionWithRequest:request delegate:delegate];
}

NSURLConnection * NSURLConnection_initWithRequest_delegate (NSURLConnection* THIS, NSURLRequest * request, NSURLConnection * delegate) {
...
NSData * NSURLConnection_sendSynchronousRequest_returningResponse_error (NSURLConnection* THIS, NSURLRequest * request, NSURLResponse ** response, NSError ** error) {
	NSLog(@"NSURLConnection_sendSynchronousRequest_returningResponse_error");
	return [THIS sendSynchronousRequest:request returningResponse:response error:error];
}
