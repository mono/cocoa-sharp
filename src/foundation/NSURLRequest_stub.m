...
NSURLRequest * NSURLRequest_requestWithURL (NSURLRequest* THIS, NSURL * URL) {
	NSLog(@"NSURLRequest_requestWithURL");
	return [THIS requestWithURL:URL];
}

NSURLRequest * NSURLRequest_requestWithURL_cachePolicy_timeoutInterval (NSURLRequest* THIS, NSURL * URL, NSURLRequestCachePolicy cachePolicy, NSTimeInterval timeoutInterval) {
	NSLog(@"NSURLRequest_requestWithURL_cachePolicy_timeoutInterval");
	return [THIS requestWithURL:URL cachePolicy:cachePolicy timeoutInterval:timeoutInterval];
}
