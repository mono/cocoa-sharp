...
NSStringEncoding NSString$_defaultCStringEncoding () {
	NSLog(@"NSString$_defaultCStringEncoding");
...
const NSStringEncoding * NSString$_availableStringEncodings () {
	NSLog(@"NSString$_availableStringEncodings");
	return [NSString availableStringEncodings];
}

NSString * NSString$_localizedNameOfStringEncoding (NSStringEncoding encoding) {
	NSLog(@"NSString$_localizedNameOfStringEncoding");
	return [NSString localizedNameOfStringEncoding:encoding];
}

NSString * NSString$_string () {
	NSLog(@"NSString$_string");
	return [NSString string];
}

NSString * NSString$_stringWithString (NSString * string) {
	NSLog(@"NSString$_stringWithString");
	return [NSString stringWithString:string];
}

NSString * NSString$_stringWithCharacters_length (const unichar * characters, unsigned length) {
	NSLog(@"NSString$_stringWithCharacters_length");
	return [NSString stringWithCharacters:characters length:length];
}

NSString * NSString$_stringWithCString_length (const char * bytes, unsigned length) {
	NSLog(@"NSString$_stringWithCString_length");
	return [NSString stringWithCString:bytes length:length];
}

NSString * NSString$_stringWithCString (const char * bytes) {
	NSLog(@"NSString$_stringWithCString");
	return [NSString stringWithCString:bytes];
}

NSString * NSString$_stringWithUTF8String (const char * bytes) {
	NSLog(@"NSString$_stringWithUTF8String");
...
NSString * NSString$_stringWithContentsOfFile (NSString * path) {
	NSLog(@"NSString$_stringWithContentsOfFile");
	return [NSString stringWithContentsOfFile:path];
}

NSString * NSString$_stringWithContentsOfURL (NSURL * url) {
	NSLog(@"NSString$_stringWithContentsOfURL");
...
NSString * NSString$_stringWithCapacity (unsigned capacity) {
	NSLog(@"NSString$_stringWithCapacity");
	return [NSString stringWithCapacity:capacity];
}
