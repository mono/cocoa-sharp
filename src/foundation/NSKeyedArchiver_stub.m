...
NSData * NSKeyedArchiver$_archivedDataWithRootObject (id rootObject) {
	NSLog(@"NSKeyedArchiver$_archivedDataWithRootObject");
	return [NSKeyedArchiver archivedDataWithRootObject:rootObject];
}

BOOL NSKeyedArchiver$_archiveRootObject_toFile (id rootObject, NSString * path) {
	NSLog(@"NSKeyedArchiver$_archiveRootObject_toFile");
...
void NSKeyedArchiver_setDelegate (NSKeyedArchiver* THIS, id delegate) {
...
void NSKeyedArchiver$_setClassName_forClass (NSString * codedName, Class cls) {
	NSLog(@"NSKeyedArchiver$_setClassName_forClass");
...
NSString * NSKeyedArchiver$_classNameForClass (Class cls) {
	NSLog(@"NSKeyedArchiver$_classNameForClass");
...
void NSKeyedArchiver_encodeObject_forKey (NSKeyedArchiver* THIS, id objv, NSString * key) {
	NSLog(@"NSKeyedArchiver_encodeObject_forKey");
	[THIS encodeObject:objv forKey:key];
}

void NSKeyedArchiver_encodeConditionalObject_forKey (NSKeyedArchiver* THIS, id objv, NSString * key) {
...
NSKeyedArchiver * NSKeyedArchiver$_unarchiveObjectWithData (NSData * data) {
	NSLog(@"NSKeyedArchiver$_unarchiveObjectWithData");
	return [NSKeyedArchiver unarchiveObjectWithData:data];
}

NSKeyedArchiver * NSKeyedArchiver$_unarchiveObjectWithFile (NSString * path) {
	NSLog(@"NSKeyedArchiver$_unarchiveObjectWithFile");
	return [NSKeyedArchiver unarchiveObjectWithFile:path];
}
...
void NSKeyedArchiver$_setClass_forClassName (Class cls, NSString * codedName) {
	NSLog(@"NSKeyedArchiver$_setClass_forClassName");
	[NSKeyedArchiver setClass:cls forClassName:codedName];
}
...
Class NSKeyedArchiver$_classForClassName (NSString * codedName) {
	NSLog(@"NSKeyedArchiver$_classForClassName");
	return [NSKeyedArchiver classForClassName:codedName];
}
...
NSKeyedArchiver * NSKeyedArchiver_archiver_willEncodeObject (NSKeyedArchiver* THIS, NSKeyedArchiver * archiver, id object) {
	NSLog(@"NSKeyedArchiver_archiver_willEncodeObject");
	return [THIS archiver:archiver willEncodeObject:object];
}

void NSKeyedArchiver_archiver_didEncodeObject (NSKeyedArchiver* THIS, NSKeyedArchiver * archiver, id object) {
	NSLog(@"NSKeyedArchiver_archiver_didEncodeObject");
	[THIS archiver:archiver didEncodeObject:object];
}

void NSKeyedArchiver_archiver_willReplaceObject_withObject (NSKeyedArchiver* THIS, NSKeyedArchiver * archiver, id object, id newObject) {
...
NSKeyedArchiver * NSKeyedArchiver_unarchiver_didDecodeObject (NSKeyedArchiver* THIS, NSKeyedUnarchiver * unarchiver, id object) {
	NSLog(@"NSKeyedArchiver_unarchiver_didDecodeObject");
	return [THIS unarchiver:unarchiver didDecodeObject:object];
}

void NSKeyedArchiver_unarchiver_willReplaceObject_withObject (NSKeyedArchiver* THIS, NSKeyedUnarchiver * unarchiver, id object, id newObject) {
...
Class NSKeyedArchiver$_classForKeyedUnarchiver () {
	NSLog(@"NSKeyedArchiver$_classForKeyedUnarchiver");
	return [NSKeyedArchiver classForKeyedUnarchiver];
}
