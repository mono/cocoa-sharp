...
NSArray * NSConnection$_allConnections () {
	NSLog(@"NSConnection$_allConnections");
	return [NSConnection allConnections];
}

NSConnection * NSConnection$_defaultConnection () {
	NSLog(@"NSConnection$_defaultConnection");
	return [NSConnection defaultConnection];
}

NSConnection * NSConnection$_connectionWithRegisteredName_host (NSString * name, NSString * hostName) {
	NSLog(@"NSConnection$_connectionWithRegisteredName_host");
	return [NSConnection connectionWithRegisteredName:name host:hostName];
}

NSConnection * NSConnection$_connectionWithRegisteredName_host_usingNameServer (NSString * name, NSString * hostName, NSPortNameServer * server) {
	NSLog(@"NSConnection$_connectionWithRegisteredName_host_usingNameServer");
	return [NSConnection connectionWithRegisteredName:name host:hostName usingNameServer:server];
}

NSDistantObject * NSConnection$_rootProxyForConnectionWithRegisteredName_host (NSString * name, NSString * hostName) {
	NSLog(@"NSConnection$_rootProxyForConnectionWithRegisteredName_host");
	return [NSConnection rootProxyForConnectionWithRegisteredName:name host:hostName];
}

NSDistantObject * NSConnection$_rootProxyForConnectionWithRegisteredName_host_usingNameServer (NSString * name, NSString * hostName, NSPortNameServer * server) {
	NSLog(@"NSConnection$_rootProxyForConnectionWithRegisteredName_host_usingNameServer");
	return [NSConnection rootProxyForConnectionWithRegisteredName:name host:hostName usingNameServer:server];
}
...
void NSConnection_setRootObject (NSConnection* THIS, id anObject) {
...
void NSConnection_setDelegate (NSConnection* THIS, id anObject) {
...
NSConnection * NSConnection$_connectionWithReceivePort_sendPort (NSPort * receivePort, NSPort * sendPort) {
	NSLog(@"NSConnection$_connectionWithReceivePort_sendPort");
	return [NSConnection connectionWithReceivePort:receivePort sendPort:sendPort];
}

NSConnection * NSConnection$_currentConversation () {
	NSLog(@"NSConnection$_currentConversation");
