...
void NSScriptCommand_setDirectParameter (NSScriptCommand* THIS, NSScriptCommand * directParameter) {
...
NSScriptCommand * NSScriptCommand_currentCommand (NSScriptCommand* THIS) {
	NSLog(@"NSScriptCommand_currentCommand");
...
void NSScriptCommand_resumeExecutionWithResult (NSScriptCommand* THIS, NSScriptCommand * result) {
