...
NSUserDefaults * NSUserDefaults_standardUserDefaults (NSUserDefaults* THIS) {
	NSLog(@"NSUserDefaults_standardUserDefaults");
	return [THIS standardUserDefaults];
}
void NSUserDefaults_resetStandardUserDefaults (NSUserDefaults* THIS) {
	NSLog(@"NSUserDefaults_resetStandardUserDefaults");
	[THIS resetStandardUserDefaults];
}
...
void NSUserDefaults_setObject_forKey (NSUserDefaults* THIS, NSUserDefaults * value, NSString * defaultName) {
