...
NSScanner * NSScanner$_scannerWithString (NSString * string) {
	NSLog(@"NSScanner$_scannerWithString");
	return [NSScanner scannerWithString:string];
}

NSScanner * NSScanner$_localizedScannerWithString (NSString * string) {
	NSLog(@"NSScanner$_localizedScannerWithString");
	return [NSScanner localizedScannerWithString:string];
}
