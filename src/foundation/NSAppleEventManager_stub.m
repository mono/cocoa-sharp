...
NSAppleEventManager * NSAppleEventManager$_sharedAppleEventManager () {
	NSLog(@"NSAppleEventManager$_sharedAppleEventManager");
	return [NSAppleEventManager sharedAppleEventManager];
}

void NSAppleEventManager_setEventHandler_andSelector_forEventClass_andEventID (NSAppleEventManager* THIS, id handler, SEL handleEventSelector, AEEventClass eventClass, AEEventID eventID) {
