...
void NSMenuItem_setUsesUserKeyEquivalents (NSMenuItem* THIS, BOOL flag) {
	NSLog(@"NSMenuItem_setUsesUserKeyEquivalents");
	[THIS setUsesUserKeyEquivalents:flag];
}

BOOL NSMenuItem_usesUserKeyEquivalents (NSMenuItem* THIS) {
	NSLog(@"NSMenuItem_usesUserKeyEquivalents");
	return [THIS usesUserKeyEquivalents];
}
/* UNSUPPORTED: 
...
void NSMenuItem_setTarget (NSMenuItem* THIS, NSMenuItem * anObject) {
...
void NSMenuItem_setRepresentedObject (NSMenuItem* THIS, NSMenuItem * anObject) {
