...
int NSPopUpButton_indexOfItemWithRepresentedObject (NSPopUpButton* THIS, id obj) {
	NSLog(@"NSPopUpButton_indexOfItemWithRepresentedObject");
	return [THIS indexOfItemWithRepresentedObject:obj];
}

int NSPopUpButton_indexOfItemWithTarget_andAction (NSPopUpButton* THIS, id target, SEL actionSelector) {
