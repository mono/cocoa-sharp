...
NSImage * NSImage$_imageNamed (NSString * name) {
	NSLog(@"NSImage$_imageNamed");
...
void NSImage_setDelegate (NSImage* THIS, id anObject) {
...
NSArray * NSImage$_imageUnfilteredFileTypes () {
	NSLog(@"NSImage$_imageUnfilteredFileTypes");
	return [NSImage imageUnfilteredFileTypes];
}

NSArray * NSImage$_imageUnfilteredPasteboardTypes () {
	NSLog(@"NSImage$_imageUnfilteredPasteboardTypes");
	return [NSImage imageUnfilteredPasteboardTypes];
}

NSArray * NSImage$_imageFileTypes () {
	NSLog(@"NSImage$_imageFileTypes");
	return [NSImage imageFileTypes];
}

NSArray * NSImage$_imagePasteboardTypes () {
	NSLog(@"NSImage$_imagePasteboardTypes");
	return [NSImage imagePasteboardTypes];
}

BOOL NSImage$_canInitWithPasteboard (NSPasteboard * pasteboard) {
	NSLog(@"NSImage$_canInitWithPasteboard");
...
NSImage * NSImage_initWithIconHandle (NSImage* THIS, void *  icon) {
	NSLog(@"NSImage_initWithIconHandle");
	return [THIS initWithIconHandle:icon];
}

NSImage * NSImage_initWithBitmapHandle (NSImage* THIS, void *  bitmap) {
	NSLog(@"NSImage_initWithBitmapHandle");
	return [THIS initWithBitmapHandle:bitmap];
}

NSImage * NSImage_imageDidNotDraw_inRect (NSImage* THIS, id sender, NSRect aRect) {
