...
Class NSBrowser$_cellClass () {
	NSLog(@"NSBrowser$_cellClass");
	return [NSBrowser cellClass];
}
...
void NSBrowser_setDelegate (NSBrowser* THIS, id anObject) {
...
void NSBrowser_selectAll (NSBrowser* THIS, id sender) {
...
void NSBrowser_doClick (NSBrowser* THIS, id sender) {
	NSLog(@"NSBrowser_doClick");
	[THIS doClick:sender];
}

void NSBrowser_doDoubleClick (NSBrowser* THIS, id sender) {
...
void NSBrowser$_removeSavedColumnsWithAutosaveName (NSString * name) {
	NSLog(@"NSBrowser$_removeSavedColumnsWithAutosaveName");
	[NSBrowser removeSavedColumnsWithAutosaveName:name];
}
...
void NSBrowser_browser_willDisplayCell_atRow_column (NSBrowser* THIS, NSBrowser * sender, id cell, int row, int column) {
