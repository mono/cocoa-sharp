...
NSOpenPanel * NSOpenPanel$_openPanel () {
	NSLog(@"NSOpenPanel$_openPanel");
...
void NSOpenPanel_beginSheetForDirectory_file_types_modalForWindow_modalDelegate_didEndSelector_contextInfo (NSOpenPanel* THIS, NSString * path, NSString * name, NSArray * fileTypes, NSWindow * docWindow, id delegate, SEL didEndSelector, void * contextInfo) {
...
void NSOpenPanel_beginForDirectory_file_types_modelessDelegate_didEndSelector_contextInfo (NSOpenPanel* THIS, NSString * path, NSString * name, NSArray * fileTypes, id delegate, SEL didEndSelector, void * contextInfo) {
