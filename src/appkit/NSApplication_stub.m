...
NSApplication * NSApplication$_sharedApplication () {
	NSLog(@"NSApplication$_sharedApplication");
	return [NSApplication sharedApplication];
}

void NSApplication_setDelegate (NSApplication* THIS, id anObject) {
...
void NSApplication_hide (NSApplication* THIS, id sender) {
	NSLog(@"NSApplication_hide");
	[THIS hide:sender];
}

void NSApplication_unhide (NSApplication* THIS, id sender) {
...
void NSApplication_hideOtherApplications (NSApplication* THIS, id sender) {
	NSLog(@"NSApplication_hideOtherApplications");
	[THIS hideOtherApplications:sender];
}

void NSApplication_unhideAllApplications (NSApplication* THIS, id sender) {
...
void NSApplication_stop (NSApplication* THIS, id sender) {
...
void NSApplication_terminate (NSApplication* THIS, id sender) {
...
void NSApplication_beginSheet_modalForWindow_modalDelegate_didEndSelector_contextInfo (NSApplication* THIS, NSWindow * sheet, NSWindow * docWindow, id modalDelegate, SEL didEndSelector, void * contextInfo) {
...
BOOL NSApplication_sendAction_to_from (NSApplication* THIS, SEL theAction, id theTarget, id sender) {
...
NSApplication * NSApplication_targetForAction_to_from (NSApplication* THIS, SEL theAction, id theTarget, id sender) {
	NSLog(@"NSApplication_targetForAction_to_from");
	return [THIS targetForAction:theAction to:theTarget from:sender];
}

BOOL NSApplication_tryToPerform_with (NSApplication* THIS, SEL anAction, id anObject) {
...
void NSApplication$_detachDrawingThread_toTarget_withObject (SEL selector, id target, id argument) {
	NSLog(@"NSApplication$_detachDrawingThread_toTarget_withObject");
...
void NSApplication_orderFrontCharacterPalette (NSApplication* THIS, id sender) {
...
void NSApplication_arrangeInFront (NSApplication* THIS, id sender) {
...
void NSApplication_miniaturizeAll (NSApplication* THIS, id sender) {
...
BOOL NSApplication_application_openFileWithoutUI (NSApplication* THIS, id sender, NSString * filename) {
...
void NSApplication_setServicesProvider (NSApplication* THIS, id provider) {
...
void NSApplication_orderFrontStandardAboutPanel (NSApplication* THIS, id sender) {
...
void NSApplication$_setApplicationHandle_commandLine_show (void *  PrevInstance, NSString * cmdLine, int cmdShow) {
	NSLog(@"NSApplication$_setApplicationHandle_commandLine_show");
	[NSApplication setApplicationHandle:PrevInstance commandLine:cmdLine show:cmdShow];
}

void NSApplication$_useRunningCopyOfApplication () {
	NSLog(@"NSApplication$_useRunningCopyOfApplication");
	[NSApplication useRunningCopyOfApplication];
}

void * /*HINSTANCE*/ NSApplication_applicationHandle (NSApplication* THIS) {
	NSLog(@"NSApplication_applicationHandle");
	[THIS applicationHandle];
}

NSWindow * NSApplication_windowWithWindowHandle (NSApplication* THIS, void *  hWnd) {
	NSLog(@"NSApplication_windowWithWindowHandle");
	return [THIS windowWithWindowHandle:hWnd];
}
