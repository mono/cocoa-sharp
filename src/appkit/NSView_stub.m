...
void NSView_sortSubviewsUsingFunction_context (NSView* THIS, void * context) {
	NSLog(@"NSView_sortSubviewsUsingFunction_context");
	[THIS sortSubviewsUsingFunctioncontext:context];
}
...
NSView * NSView_focusView (NSView* THIS) {
	NSLog(@"NSView_focusView");
...
NSTrackingRectTag NSView_addTrackingRect_owner_userData_assumeInside (NSView* THIS, NSRect aRect, NSView * anObject, void * data, BOOL flag) {
...
NSMenu * NSView_defaultMenu (NSView* THIS) {
	NSLog(@"NSView_defaultMenu");
...
NSToolTipTag NSView_addToolTipRect_owner_userData (NSView* THIS, NSRect aRect, NSView * anObject, void * data) {
...
NSFocusRingType NSView_defaultFocusRingType (NSView* THIS) {
	NSLog(@"NSView_defaultFocusRingType");
...
void NSView_print (NSView* THIS, NSView * sender) {
	NSLog(@"NSView_print");
	[THIS print:sender];
}
...
void NSView_dragImage_at_offset_event_pasteboard_source_slideBack (NSView* THIS, NSImage * anImage, NSPoint viewLocation, NSSize initialOffset, NSEvent * event, NSPasteboard * pboard, NSView * sourceObj, BOOL slideFlag) {
...
BOOL NSView_dragPromisedFilesOfTypes_fromRect_source_slideBack_event (NSView* THIS, NSArray * typeArray, NSRect rect, NSView * sourceObject, BOOL aFlag, NSEvent * event) {
