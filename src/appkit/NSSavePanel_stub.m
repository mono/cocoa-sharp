...
NSSavePanel * NSSavePanel_savePanel (NSSavePanel* THIS) {
	NSLog(@"NSSavePanel_savePanel");
...
void NSSavePanel_setDelegate (NSSavePanel* THIS, NSSavePanel * delegate) {
...
IBAction NSSavePanel_selectText (NSSavePanel* THIS, NSSavePanel * sender) {
	NSLog(@"NSSavePanel_selectText");
	return [THIS selectText:sender];
}

IBAction NSSavePanel_ok (NSSavePanel* THIS, NSSavePanel * sender) {
	NSLog(@"NSSavePanel_ok");
	return [THIS ok:sender];
}

IBAction NSSavePanel_cancel (NSSavePanel* THIS, NSSavePanel * sender) {
	NSLog(@"NSSavePanel_cancel");
	return [THIS cancel:sender];
}

void NSSavePanel_beginSheetForDirectory_file_modalForWindow_modalDelegate_didEndSelector_contextInfo (NSSavePanel* THIS, NSString * path, NSString * name, NSWindow * docWindow, NSSavePanel * delegate, SEL didEndSelector, void * contextInfo) {
...
BOOL NSSavePanel_panel_shouldShowFilename (NSSavePanel* THIS, NSSavePanel * sender, NSString * filename) {
	NSLog(@"NSSavePanel_panel_shouldShowFilename");
	return [THIS panel:sender shouldShowFilename:filename];
}

NSComparisonResult NSSavePanel_panel_compareFilename_with_caseSensitive (NSSavePanel* THIS, NSSavePanel * sender, NSString * name1, NSString * name2, BOOL caseSensitive) {
...
BOOL NSSavePanel_panel_isValidFilename (NSSavePanel* THIS, NSSavePanel * sender, NSString * filename) {
	NSLog(@"NSSavePanel_panel_isValidFilename");
	return [THIS panel:sender isValidFilename:filename];
}

NSString * NSSavePanel_panel_userEnteredFilename_confirmed (NSSavePanel* THIS, NSSavePanel * sender, NSString * filename, BOOL okFlag) {
...
void NSSavePanel_panel_willExpand (NSSavePanel* THIS, NSSavePanel * sender, BOOL expanding) {
	NSLog(@"NSSavePanel_panel_willExpand");
	[THIS panel:sender willExpand:expanding];
}

void NSSavePanel_panel_directoryDidChange (NSSavePanel* THIS, NSSavePanel * sender, NSString * path) {
	NSLog(@"NSSavePanel_panel_directoryDidChange");
	[THIS panel:sender directoryDidChange:path];
}

void NSSavePanel_panelSelectionDidChange (NSSavePanel* THIS, NSSavePanel * sender) {
