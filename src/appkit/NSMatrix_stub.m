...
void NSMatrix_sendAction_to_forAllCells (NSMatrix* THIS, SEL aSelector, id anObject, BOOL flag) {
...
void NSMatrix_context (NSMatrix* THIS, void * context) {
	NSLog(@"NSMatrix_context");
...
void NSMatrix_selectAll (NSMatrix* THIS, id sender) {
...
void NSMatrix_setDelegate (NSMatrix* THIS, id anObject) {
...
void NSMatrix_selectText (NSMatrix* THIS, id sender) {
