...
void NSAlert_setDelegate (NSAlert* THIS, NSAlert * delegate) {
...
void NSAlert_beginSheetModalForWindow_modalDelegate_didEndSelector_contextInfo (NSAlert* THIS, NSWindow * window, NSAlert * delegate, SEL didEndSelector, void * contextInfo) {
