...
void NSDocument_shouldCloseWindowController_delegate_shouldCloseSelector_contextInfo (NSDocument* THIS, NSWindowController * windowController, NSDocument * delegate, SEL callback, void * contextInfo) {
...
void NSDocument_canCloseDocumentWithDelegate_shouldCloseSelector_contextInfo (NSDocument* THIS, NSDocument * delegate, SEL shouldCloseSelector, void * contextInfo) {
...
IBAction NSDocument_saveDocument (NSDocument* THIS, NSDocument * sender) {
	NSLog(@"NSDocument_saveDocument");
	return [THIS saveDocument:sender];
}

IBAction NSDocument_saveDocumentAs (NSDocument* THIS, NSDocument * sender) {
	NSLog(@"NSDocument_saveDocumentAs");
	return [THIS saveDocumentAs:sender];
}

IBAction NSDocument_saveDocumentTo (NSDocument* THIS, NSDocument * sender) {
	NSLog(@"NSDocument_saveDocumentTo");
	return [THIS saveDocumentTo:sender];
}

IBAction NSDocument_revertDocumentToSaved (NSDocument* THIS, NSDocument * sender) {
...
void NSDocument_saveDocumentWithDelegate_didSaveSelector_contextInfo (NSDocument* THIS, NSDocument * delegate, SEL didSaveSelector, void * contextInfo) {
...
void NSDocument_saveToFile_saveOperation_delegate_didSaveSelector_contextInfo (NSDocument* THIS, NSString * fileName, NSSaveOperationType saveOperation, NSDocument * delegate, SEL didSaveSelector, void * contextInfo) {
...
void NSDocument_runModalSavePanelForSaveOperation_delegate_didSaveSelector_contextInfo (NSDocument* THIS, NSSaveOperationType saveOperation, NSDocument * delegate, SEL didSaveSelector, void * contextInfo) {
...
void NSDocument_runModalPageLayoutWithPrintInfo_delegate_didRunSelector_contextInfo (NSDocument* THIS, NSPrintInfo * printInfo, NSDocument * delegate, SEL didRunSelector, void * contextInfo) {
...
IBAction NSDocument_runPageLayout (NSDocument* THIS, NSDocument * sender) {
...
void NSDocument_runModalPrintOperation_delegate_didRunSelector_contextInfo (NSDocument* THIS, NSPrintOperation * printOperation, NSDocument * delegate, SEL didRunSelector, void * contextInfo) {
...
IBAction NSDocument_printDocument (NSDocument* THIS, NSDocument * sender) {
...
NSArray * NSDocument_readableTypes (NSDocument* THIS) {
	NSLog(@"NSDocument_readableTypes");
	return [THIS readableTypes];
}
NSArray * NSDocument_writableTypes (NSDocument* THIS) {
	NSLog(@"NSDocument_writableTypes");
	return [THIS writableTypes];
}
BOOL NSDocument_isNativeType (NSDocument* THIS, NSString * type) {
	NSLog(@"NSDocument_isNativeType");
