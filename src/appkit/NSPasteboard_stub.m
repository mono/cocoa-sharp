...
NSPasteboard * NSPasteboard_generalPasteboard (NSPasteboard* THIS) {
	NSLog(@"NSPasteboard_generalPasteboard");
	return [THIS generalPasteboard];
}
NSPasteboard * NSPasteboard_pasteboardWithName (NSPasteboard* THIS, NSString * name) {
	NSLog(@"NSPasteboard_pasteboardWithName");
	return [THIS pasteboardWithName:name];
}

NSPasteboard * NSPasteboard_pasteboardWithUniqueName (NSPasteboard* THIS) {
	NSLog(@"NSPasteboard_pasteboardWithUniqueName");
	return [THIS pasteboardWithUniqueName];
}
NSArray * NSPasteboard_typesFilterableTo (NSPasteboard* THIS, NSString * type) {
	NSLog(@"NSPasteboard_typesFilterableTo");
	return [THIS typesFilterableTo:type];
}

NSPasteboard * NSPasteboard_pasteboardByFilteringFile (NSPasteboard* THIS, NSString * filename) {
	NSLog(@"NSPasteboard_pasteboardByFilteringFile");
	return [THIS pasteboardByFilteringFile:filename];
}

NSPasteboard * NSPasteboard_pasteboardByFilteringData_ofType (NSPasteboard* THIS, NSData * data, NSString * type) {
	NSLog(@"NSPasteboard_pasteboardByFilteringData_ofType");
	return [THIS pasteboardByFilteringData:data ofType:type];
}

NSPasteboard * NSPasteboard_pasteboardByFilteringTypesInPasteboard (NSPasteboard* THIS, NSPasteboard * pboard) {
	NSLog(@"NSPasteboard_pasteboardByFilteringTypesInPasteboard");
	return [THIS pasteboardByFilteringTypesInPasteboard:pboard];
}
...
int NSPasteboard_declareTypes_owner (NSPasteboard* THIS, NSArray * newTypes, NSPasteboard * newOwner) {
	NSLog(@"NSPasteboard_declareTypes_owner");
	return [THIS declareTypes:newTypes owner:newOwner];
}

int NSPasteboard_addTypes_owner (NSPasteboard* THIS, NSArray * newTypes, NSPasteboard * newOwner) {
...
BOOL NSPasteboard_setPropertyList_forType (NSPasteboard* THIS, NSPasteboard * plist, NSString * dataType) {
...
NSURL * NSPasteboard_URLFromPasteboard (NSPasteboard* THIS, NSPasteboard * pasteBoard) {
	NSLog(@"NSPasteboard_URLFromPasteboard");
	return [THIS URLFromPasteboard:pasteBoard];
}
