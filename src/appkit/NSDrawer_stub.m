...
void NSDrawer_setDelegate (NSDrawer* THIS, id anObject) {
...
void NSDrawer_open (NSDrawer* THIS, id sender) {
	NSLog(@"NSDrawer_open");
	[THIS open:sender];
}

void NSDrawer_close (NSDrawer* THIS, id sender) {
	NSLog(@"NSDrawer_close");
	[THIS close:sender];
}

void NSDrawer_toggle (NSDrawer* THIS, id sender) {
