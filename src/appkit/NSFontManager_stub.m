...
void NSFontManager_setFontPanelFactory (NSFontManager* THIS, Class factoryId) {
	NSLog(@"NSFontManager_setFontPanelFactory");
	[THIS setFontPanelFactory:factoryId];
}

void NSFontManager_setFontManagerFactory (NSFontManager* THIS, Class factoryId) {
	NSLog(@"NSFontManager_setFontManagerFactory");
	[THIS setFontManagerFactory:factoryId];
}

NSFontManager * NSFontManager_sharedFontManager (NSFontManager* THIS) {
	NSLog(@"NSFontManager_sharedFontManager");
	return [THIS sharedFontManager];
}
...
void NSFontManager_setDelegate (NSFontManager* THIS, NSFontManager * anObject) {
...
BOOL NSFontManager_addCollection (NSFontManager* THIS, NSString *  collectionName, int  collectionOptions) {
	NSLog(@"NSFontManager_addCollection");
	return [THIS addCollection: collectionName : collectionOptions];
}
...
void NSFontManager_addFontDescriptors (NSFontManager* THIS, NSArray *  descriptors , NSString *  collectionName) {
	NSLog(@"NSFontManager_addFontDescriptors");
	[THIS addFontDescriptors: descriptors  : collectionName];
}

void NSFontManager_removeFontDescriptor (NSFontManager* THIS, NSFontDescriptor *  descriptor, NSString *  collection) {
	NSLog(@"NSFontManager_removeFontDescriptor");
	[THIS removeFontDescriptor: descriptor : collection];
}
...
void NSFontManager_addFontTrait (NSFontManager* THIS, NSFontManager * sender) {
	NSLog(@"NSFontManager_addFontTrait");
	[THIS addFontTrait:sender];
}

void NSFontManager_removeFontTrait (NSFontManager* THIS, NSFontManager * sender) {
	NSLog(@"NSFontManager_removeFontTrait");
	[THIS removeFontTrait:sender];
}

void NSFontManager_modifyFontViaPanel (NSFontManager* THIS, NSFontManager * sender) {
	NSLog(@"NSFontManager_modifyFontViaPanel");
	[THIS modifyFontViaPanel:sender];
}

void NSFontManager_modifyFont (NSFontManager* THIS, NSFontManager * sender) {
	NSLog(@"NSFontManager_modifyFont");
	[THIS modifyFont:sender];
}

void NSFontManager_orderFrontFontPanel (NSFontManager* THIS, NSFontManager * sender) {
	NSLog(@"NSFontManager_orderFrontFontPanel");
	[THIS orderFrontFontPanel:sender];
}

void NSFontManager_orderFrontStylesPanel (NSFontManager* THIS, NSFontManager * sender) {
	NSLog(@"NSFontManager_orderFrontStylesPanel");
	[THIS orderFrontStylesPanel:sender];
}

BOOL NSFontManager_fontManager_willIncludeFont (NSFontManager* THIS, NSFontManager * sender, NSString * fontName) {
	NSLog(@"NSFontManager_fontManager_willIncludeFont");
	return [THIS fontManager:sender willIncludeFont:fontName];
}

void NSFontManager_changeFont (NSFontManager* THIS, NSFontManager * sender) {
