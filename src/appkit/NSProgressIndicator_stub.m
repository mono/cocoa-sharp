...
void NSProgressIndicator_startAnimation (NSProgressIndicator* THIS, NSProgressIndicator * sender) {
	NSLog(@"NSProgressIndicator_startAnimation");
	[THIS startAnimation:sender];
}

void NSProgressIndicator_stopAnimation (NSProgressIndicator* THIS, NSProgressIndicator * sender) {
	NSLog(@"NSProgressIndicator_stopAnimation");
	[THIS stopAnimation:sender];
}

void NSProgressIndicator_animate (NSProgressIndicator* THIS, NSProgressIndicator * sender) {
