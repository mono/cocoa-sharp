...
NSRect NSWindow_frameRectForContentRect_styleMask (NSWindow* THIS, NSRect cRect, unsigned int aStyle) {
	NSLog(@"NSWindow_frameRectForContentRect_styleMask");
	return [THIS frameRectForContentRect:cRect styleMask:aStyle];
}

NSRect NSWindow_contentRectForFrameRect_styleMask (NSWindow* THIS, NSRect fRect, unsigned int aStyle) {
	NSLog(@"NSWindow_contentRectForFrameRect_styleMask");
	return [THIS contentRectForFrameRect:fRect styleMask:aStyle];
}

float NSWindow_minFrameWidthWithTitle_styleMask (NSWindow* THIS, NSString * aTitle, unsigned int aStyle) {
	NSLog(@"NSWindow_minFrameWidthWithTitle_styleMask");
	return [THIS minFrameWidthWithTitle:aTitle styleMask:aStyle];
}

NSWindowDepth NSWindow_defaultDepthLimit (NSWindow* THIS) {
	NSLog(@"NSWindow_defaultDepthLimit");
	return [THIS defaultDepthLimit];
}
...
void NSWindow_setDelegate (NSWindow* THIS, NSWindow * anObject) {
...
NSText * NSWindow_fieldEditor_forObject (NSWindow* THIS, BOOL createFlag, NSWindow * anObject) {
	NSLog(@"NSWindow_fieldEditor_forObject");
	return [THIS fieldEditor:createFlag forObject:anObject];
}

void NSWindow_endEditingFor (NSWindow* THIS, NSWindow * anObject) {
...
void NSWindow_miniaturize (NSWindow* THIS, NSWindow * sender) {
	NSLog(@"NSWindow_miniaturize");
	[THIS miniaturize:sender];
}

void NSWindow_deminiaturize (NSWindow* THIS, NSWindow * sender) {
...
void NSWindow_zoom (NSWindow* THIS, NSWindow * sender) {
	NSLog(@"NSWindow_zoom");
	[THIS zoom:sender];
}
...
BOOL NSWindow_tryToPerform_with (NSWindow* THIS, SEL anAction, NSWindow * anObject) {
...
void NSWindow_makeKeyAndOrderFront (NSWindow* THIS, NSWindow * sender) {
	NSLog(@"NSWindow_makeKeyAndOrderFront");
	[THIS makeKeyAndOrderFront:sender];
}

void NSWindow_orderFront (NSWindow* THIS, NSWindow * sender) {
	NSLog(@"NSWindow_orderFront");
	[THIS orderFront:sender];
}

void NSWindow_orderBack (NSWindow* THIS, NSWindow * sender) {
	NSLog(@"NSWindow_orderBack");
	[THIS orderBack:sender];
}

void NSWindow_orderOut (NSWindow* THIS, NSWindow * sender) {
...
void NSWindow_performClose (NSWindow* THIS, NSWindow * sender) {
	NSLog(@"NSWindow_performClose");
	[THIS performClose:sender];
}

void NSWindow_performMiniaturize (NSWindow* THIS, NSWindow * sender) {
	NSLog(@"NSWindow_performMiniaturize");
	[THIS performMiniaturize:sender];
}

void NSWindow_performZoom (NSWindow* THIS, NSWindow * sender) {
...
void NSWindow_print (NSWindow* THIS, NSWindow * sender) {
...
void NSWindow_removeFrameUsingName (NSWindow* THIS, NSString * name) {
	NSLog(@"NSWindow_removeFrameUsingName");
	[THIS removeFrameUsingName:name];
}
...
void NSWindow_menuChanged (NSWindow* THIS, NSMenu * menu) {
	NSLog(@"NSWindow_menuChanged");
...
NSButton * NSWindow_standardWindowButton_forStyleMask (NSWindow* THIS, NSWindowButton b, unsigned int styleMask) {
	NSLog(@"NSWindow_standardWindowButton_forStyleMask");
	return [THIS standardWindowButton:b forStyleMask:styleMask];
}
...
void NSWindow_selectNextKeyView (NSWindow* THIS, NSWindow * sender) {
	NSLog(@"NSWindow_selectNextKeyView");
	[THIS selectNextKeyView:sender];
}

void NSWindow_selectPreviousKeyView (NSWindow* THIS, NSWindow * sender) {
...
void NSWindow_toggleToolbarShown (NSWindow* THIS, NSWindow * sender) {
	NSLog(@"NSWindow_toggleToolbarShown");
	[THIS toggleToolbarShown:sender];
}

void NSWindow_runToolbarCustomizationPalette (NSWindow* THIS, NSWindow * sender) {
	NSLog(@"NSWindow_runToolbarCustomizationPalette");
	[THIS runToolbarCustomizationPalette:sender];
}

void NSWindow_dragImage_at_offset_event_pasteboard_source_slideBack (NSWindow* THIS, NSImage * anImage, NSPoint baseLocation, NSSize initialOffset, NSEvent * event, NSPasteboard * pboard, NSWindow * sourceObj, BOOL slideFlag) {
...
BOOL NSWindow_windowShouldClose (NSWindow* THIS, NSWindow * sender) {
	NSLog(@"NSWindow_windowShouldClose");
	return [THIS windowShouldClose:sender];
}

NSWindow * NSWindow_windowWillReturnFieldEditor_toObject (NSWindow* THIS, NSWindow * sender, NSWindow * client) {
