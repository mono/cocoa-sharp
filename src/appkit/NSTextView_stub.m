...
void NSTextView_insertText (NSTextView* THIS, NSTextView * insertString) {
...
void NSTextView_turnOffKerning (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_turnOffKerning");
	[THIS turnOffKerning:sender];
}

void NSTextView_tightenKerning (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_tightenKerning");
	[THIS tightenKerning:sender];
}

void NSTextView_loosenKerning (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_loosenKerning");
	[THIS loosenKerning:sender];
}

void NSTextView_useStandardKerning (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_useStandardKerning");
	[THIS useStandardKerning:sender];
}

void NSTextView_turnOffLigatures (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_turnOffLigatures");
	[THIS turnOffLigatures:sender];
}

void NSTextView_useStandardLigatures (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_useStandardLigatures");
	[THIS useStandardLigatures:sender];
}

void NSTextView_useAllLigatures (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_useAllLigatures");
	[THIS useAllLigatures:sender];
}

void NSTextView_raiseBaseline (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_raiseBaseline");
	[THIS raiseBaseline:sender];
}

void NSTextView_lowerBaseline (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_lowerBaseline");
	[THIS lowerBaseline:sender];
}

void NSTextView_toggleTraditionalCharacterShape (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_toggleTraditionalCharacterShape");
	[THIS toggleTraditionalCharacterShape:sender];
}

void NSTextView_outline (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_outline");
	[THIS outline:sender];
}

void NSTextView_performFindPanelAction (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_performFindPanelAction");
	[THIS performFindPanelAction:sender];
}

void NSTextView_alignJustified (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_alignJustified");
	[THIS alignJustified:sender];
}

void NSTextView_changeColor (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_changeColor");
	[THIS changeColor:sender];
}

void NSTextView_changeAttributes (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_changeAttributes");
	[THIS changeAttributes:sender];
}

void NSTextView_changeDocumentBackgroundColor (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_changeDocumentBackgroundColor");
	[THIS changeDocumentBackgroundColor:sender];
}

void NSTextView_toggleBaseWritingDirection (NSTextView* THIS, NSTextView * sender) {
...
void NSTextView_clickedOnLink_atIndex (NSTextView* THIS, NSTextView * link, unsigned charIndex) {
	NSLog(@"NSTextView_clickedOnLink_atIndex");
	[THIS clickedOnLink:link atIndex:charIndex];
}

void NSTextView_startSpeaking (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_startSpeaking");
	[THIS startSpeaking:sender];
}

void NSTextView_stopSpeaking (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_stopSpeaking");
	[THIS stopSpeaking:sender];
}

void NSTextView_complete (NSTextView* THIS, NSTextView * sender) {
...
void NSTextView_registerForServices (NSTextView* THIS) {
	NSLog(@"NSTextView_registerForServices");
...
void NSTextView_pasteAsPlainText (NSTextView* THIS, NSTextView * sender) {
	NSLog(@"NSTextView_pasteAsPlainText");
	[THIS pasteAsPlainText:sender];
}

void NSTextView_pasteAsRichText (NSTextView* THIS, NSTextView * sender) {
...
void NSTextView_toggleContinuousSpellChecking (NSTextView* THIS, NSTextView * sender) {
...
void NSTextView_setDelegate (NSTextView* THIS, NSTextView * anObject) {
...
BOOL NSTextView_textView_clickedOnLink_atIndex (NSTextView* THIS, NSTextView * textView, NSTextView * link, unsigned charIndex) {
...
BOOL NSTextView_textView_clickedOnLink (NSTextView* THIS, NSTextView * textView, NSTextView * link) {
