...
void NSInputManager_insertText (NSInputManager* THIS, id aString) {
...
void NSInputManager_setMarkedText_selectedRange (NSInputManager* THIS, id aString, NSRange selRange) {
...
NSInputManager * NSInputManager$_currentInputManager () {
	NSLog(@"NSInputManager$_currentInputManager");
	return [NSInputManager currentInputManager];
}

void NSInputManager$_cycleToNextInputLanguage (id sender) {
	NSLog(@"NSInputManager$_cycleToNextInputLanguage");
	[NSInputManager cycleToNextInputLanguage:sender];
}

void NSInputManager$_cycleToNextInputServerInLanguage (id sender) {
	NSLog(@"NSInputManager$_cycleToNextInputServerInLanguage");
	[NSInputManager cycleToNextInputServerInLanguage:sender];
}
...
void NSInputManager_markedTextAbandoned (NSInputManager* THIS, id cli) {
	NSLog(@"NSInputManager_markedTextAbandoned");
	[THIS markedTextAbandoned:cli];
}

void NSInputManager_markedTextSelectionChanged_client (NSInputManager* THIS, NSRange newSel, id cli) {
