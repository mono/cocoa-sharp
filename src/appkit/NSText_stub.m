...
void NSText_setDelegate (NSText* THIS, id anObject) {
...
void NSText_copy (NSText* THIS, id sender) {
	NSLog(@"NSText_copy");
	[THIS copy:sender];
}

void NSText_copyFont (NSText* THIS, id sender) {
	NSLog(@"NSText_copyFont");
	[THIS copyFont:sender];
}

void NSText_copyRuler (NSText* THIS, id sender) {
	NSLog(@"NSText_copyRuler");
	[THIS copyRuler:sender];
}

void NSText_cut (NSText* THIS, id sender) {
	NSLog(@"NSText_cut");
	[THIS cut:sender];
}

void NSText_delete (NSText* THIS, id sender) {
	NSLog(@"NSText_delete");
	[THIS delete:sender];
}

void NSText_paste (NSText* THIS, id sender) {
	NSLog(@"NSText_paste");
	[THIS paste:sender];
}

void NSText_pasteFont (NSText* THIS, id sender) {
	NSLog(@"NSText_pasteFont");
	[THIS pasteFont:sender];
}

void NSText_pasteRuler (NSText* THIS, id sender) {
	NSLog(@"NSText_pasteRuler");
	[THIS pasteRuler:sender];
}

void NSText_selectAll (NSText* THIS, id sender) {
	NSLog(@"NSText_selectAll");
	[THIS selectAll:sender];
}

void NSText_changeFont (NSText* THIS, id sender) {
	NSLog(@"NSText_changeFont");
	[THIS changeFont:sender];
}

void NSText_alignLeft (NSText* THIS, id sender) {
	NSLog(@"NSText_alignLeft");
	[THIS alignLeft:sender];
}

void NSText_alignRight (NSText* THIS, id sender) {
	NSLog(@"NSText_alignRight");
	[THIS alignRight:sender];
}

void NSText_alignCenter (NSText* THIS, id sender) {
	NSLog(@"NSText_alignCenter");
	[THIS alignCenter:sender];
}

void NSText_subscript (NSText* THIS, id sender) {
	NSLog(@"NSText_subscript");
	[THIS subscript:sender];
}

void NSText_superscript (NSText* THIS, id sender) {
	NSLog(@"NSText_superscript");
	[THIS superscript:sender];
}

void NSText_underline (NSText* THIS, id sender) {
	NSLog(@"NSText_underline");
	[THIS underline:sender];
}

void NSText_unscript (NSText* THIS, id sender) {
	NSLog(@"NSText_unscript");
	[THIS unscript:sender];
}

void NSText_showGuessPanel (NSText* THIS, id sender) {
	NSLog(@"NSText_showGuessPanel");
	[THIS showGuessPanel:sender];
}

void NSText_checkSpelling (NSText* THIS, id sender) {
	NSLog(@"NSText_checkSpelling");
	[THIS checkSpelling:sender];
}

void NSText_toggleRuler (NSText* THIS, id sender) {
