...
NSArray * NSPrinter_printerNames (NSPrinter* THIS) {
	NSLog(@"NSPrinter_printerNames");
	return [THIS printerNames];
}
NSArray * NSPrinter_printerTypes (NSPrinter* THIS) {
	NSLog(@"NSPrinter_printerTypes");
	return [THIS printerTypes];
}
NSPrinter * NSPrinter_printerWithName (NSPrinter* THIS, NSString * name) {
	NSLog(@"NSPrinter_printerWithName");
	return [THIS printerWithName:name];
}

NSPrinter * NSPrinter_printerWithType (NSPrinter* THIS, NSString * type) {
	NSLog(@"NSPrinter_printerWithType");
	return [THIS printerWithType:type];
}
...
NSPrinter * NSPrinter_printerWithName_domain_includeUnavailable (NSPrinter* THIS, NSString * name, NSString * domain, BOOL flag) {
	NSLog(@"NSPrinter_printerWithName_domain_includeUnavailable");
	return [THIS printerWithName:name domain:domain includeUnavailable:flag];
}
