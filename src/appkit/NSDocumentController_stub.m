...
NSDocumentController * NSDocumentController_sharedDocumentController (NSDocumentController* THIS) {
	NSLog(@"NSDocumentController_sharedDocumentController");
	return [THIS sharedDocumentController];
}
...
IBAction NSDocumentController_saveAllDocuments (NSDocumentController* THIS, NSDocumentController * sender) {
	NSLog(@"NSDocumentController_saveAllDocuments");
	return [THIS saveAllDocuments:sender];
}

IBAction NSDocumentController_openDocument (NSDocumentController* THIS, NSDocumentController * sender) {
	NSLog(@"NSDocumentController_openDocument");
	return [THIS openDocument:sender];
}

IBAction NSDocumentController_newDocument (NSDocumentController* THIS, NSDocumentController * sender) {
...
void NSDocumentController_closeAllDocumentsWithDelegate_didCloseAllSelector_contextInfo (NSDocumentController* THIS, NSDocumentController * delegate, SEL didAllCloseSelector, void * contextInfo) {
...
void NSDocumentController_reviewUnsavedDocumentsWithAlertTitle_cancellable_delegate_didReviewAllSelector_contextInfo (NSDocumentController* THIS, NSString * title, BOOL cancellable, NSDocumentController * delegate, SEL didReviewAllSelector, void * contextInfo) {
...
IBAction NSDocumentController_clearRecentDocuments (NSDocumentController* THIS, NSDocumentController * sender) {
