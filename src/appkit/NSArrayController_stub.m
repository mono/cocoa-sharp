...
void NSArrayController_insert (NSArrayController* THIS, NSArrayController * sender) {
...
void NSArrayController_selectNext (NSArrayController* THIS, NSArrayController * sender) {
	NSLog(@"NSArrayController_selectNext");
	[THIS selectNext:sender];
}

void NSArrayController_selectPrevious (NSArrayController* THIS, NSArrayController * sender) {
...
void NSArrayController_addObject (NSArrayController* THIS, NSArrayController * object) {
...
void NSArrayController_insertObject_atArrangedObjectIndex (NSArrayController* THIS, NSArrayController * object, unsigned int index) {
...
void NSArrayController_removeObject (NSArrayController* THIS, NSArrayController * object) {
