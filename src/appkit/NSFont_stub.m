...
NSFont * NSFont_fontWithName_size (NSFont* THIS, NSString * fontName, float fontSize) {
	NSLog(@"NSFont_fontWithName_size");
	return [THIS fontWithName:fontName size:fontSize];
}

NSFont * NSFont_fontWithName_matrix (NSFont* THIS, NSString * fontName, const float * fontMatrix) {
	NSLog(@"NSFont_fontWithName_matrix");
	return [THIS fontWithName:fontName matrix:fontMatrix];
}

void NSFont_useFont (NSFont* THIS, NSString * fontName) {
	NSLog(@"NSFont_useFont");
	[THIS useFont:fontName];
}

NSFont * NSFont_userFontOfSize (NSFont* THIS, float fontSize) {
	NSLog(@"NSFont_userFontOfSize");
	return [THIS userFontOfSize:fontSize];
}

NSFont * NSFont_userFixedPitchFontOfSize (NSFont* THIS, float fontSize) {
	NSLog(@"NSFont_userFixedPitchFontOfSize");
	return [THIS userFixedPitchFontOfSize:fontSize];
}

void NSFont_setUserFont (NSFont* THIS, NSFont * aFont) {
	NSLog(@"NSFont_setUserFont");
	[THIS setUserFont:aFont];
}

void NSFont_setUserFixedPitchFont (NSFont* THIS, NSFont * aFont) {
	NSLog(@"NSFont_setUserFixedPitchFont");
	[THIS setUserFixedPitchFont:aFont];
}

NSFont * NSFont_systemFontOfSize (NSFont* THIS, float fontSize) {
	NSLog(@"NSFont_systemFontOfSize");
	return [THIS systemFontOfSize:fontSize];
}

NSFont * NSFont_boldSystemFontOfSize (NSFont* THIS, float fontSize) {
	NSLog(@"NSFont_boldSystemFontOfSize");
	return [THIS boldSystemFontOfSize:fontSize];
}

NSFont * NSFont_labelFontOfSize (NSFont* THIS, float fontSize) {
	NSLog(@"NSFont_labelFontOfSize");
	return [THIS labelFontOfSize:fontSize];
}

float NSFont_systemFontSize (NSFont* THIS) {
	NSLog(@"NSFont_systemFontSize");
	return [THIS systemFontSize];
}
float NSFont_smallSystemFontSize (NSFont* THIS) {
	NSLog(@"NSFont_smallSystemFontSize");
	return [THIS smallSystemFontSize];
}
float NSFont_labelFontSize (NSFont* THIS) {
	NSLog(@"NSFont_labelFontSize");
	return [THIS labelFontSize];
}
float NSFont_systemFontSizeForControlSize (NSFont* THIS, NSControlSize controlSize) {
	NSLog(@"NSFont_systemFontSizeForControlSize");
	return [THIS systemFontSizeForControlSize:controlSize];
}

NSFont * NSFont_titleBarFontOfSize (NSFont* THIS, float fontSize) {
	NSLog(@"NSFont_titleBarFontOfSize");
	return [THIS titleBarFontOfSize:fontSize];
}

NSFont * NSFont_menuFontOfSize (NSFont* THIS, float fontSize) {
	NSLog(@"NSFont_menuFontOfSize");
	return [THIS menuFontOfSize:fontSize];
}

NSFont * NSFont_menuBarFontOfSize (NSFont* THIS, float fontSize) {
	NSLog(@"NSFont_menuBarFontOfSize");
	return [THIS menuBarFontOfSize:fontSize];
}

NSFont * NSFont_messageFontOfSize (NSFont* THIS, float fontSize) {
	NSLog(@"NSFont_messageFontOfSize");
	return [THIS messageFontOfSize:fontSize];
}

NSFont * NSFont_paletteFontOfSize (NSFont* THIS, float fontSize) {
	NSLog(@"NSFont_paletteFontOfSize");
	return [THIS paletteFontOfSize:fontSize];
}

NSFont * NSFont_toolTipsFontOfSize (NSFont* THIS, float fontSize) {
	NSLog(@"NSFont_toolTipsFontOfSize");
	return [THIS toolTipsFontOfSize:fontSize];
}

NSFont * NSFont_controlContentFontOfSize (NSFont* THIS, float fontSize) {
	NSLog(@"NSFont_controlContentFontOfSize");
	return [THIS controlContentFontOfSize:fontSize];
}
...
NSArray * NSFont_preferredFontNames (NSFont* THIS) {
	NSLog(@"NSFont_preferredFontNames");
	return [THIS preferredFontNames];
}
void NSFont_setPreferredFontNames (NSFont* THIS, NSArray * fontNameArray) {
	NSLog(@"NSFont_setPreferredFontNames");
	[THIS setPreferredFontNames:fontNameArray];
}
