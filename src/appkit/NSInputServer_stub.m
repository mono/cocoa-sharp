...
void NSInputServer_insertText_client (NSInputServer* THIS, id aString, id sender) {
	NSLog(@"NSInputServer_insertText_client");
	[THIS insertText:aString client:sender];
}

void NSInputServer_doCommandBySelector_client (NSInputServer* THIS, SEL aSelector, id sender) {
	NSLog(@"NSInputServer_doCommandBySelector_client");
	[THIS doCommandBySelector:aSelector client:sender];
}

void NSInputServer_markedTextAbandoned (NSInputServer* THIS, id sender) {
	NSLog(@"NSInputServer_markedTextAbandoned");
	[THIS markedTextAbandoned:sender];
}

void NSInputServer_markedTextSelectionChanged_client (NSInputServer* THIS, NSRange newSel, id sender) {
	NSLog(@"NSInputServer_markedTextSelectionChanged_client");
	[THIS markedTextSelectionChanged:newSel client:sender];
}

void NSInputServer_terminate (NSInputServer* THIS, id sender) {
...
void NSInputServer_inputClientBecomeActive (NSInputServer* THIS, id sender) {
	NSLog(@"NSInputServer_inputClientBecomeActive");
	[THIS inputClientBecomeActive:sender];
}

void NSInputServer_inputClientResignActive (NSInputServer* THIS, id sender) {
	NSLog(@"NSInputServer_inputClientResignActive");
	[THIS inputClientResignActive:sender];
}

void NSInputServer_inputClientEnabled (NSInputServer* THIS, id sender) {
	NSLog(@"NSInputServer_inputClientEnabled");
	[THIS inputClientEnabled:sender];
}

void NSInputServer_inputClientDisabled (NSInputServer* THIS, id sender) {
	NSLog(@"NSInputServer_inputClientDisabled");
	[THIS inputClientDisabled:sender];
}

void NSInputServer_activeConversationWillChange_fromOldConversation (NSInputServer* THIS, id sender, long oldConversation) {
...
void NSInputServer_activeConversationChanged_toNewConversation (NSInputServer* THIS, id sender, long newConversation) {
...
BOOL NSInputServer_mouseDownOnCharacterIndex_atCoordinate_withModifier_client (NSInputServer* THIS, unsigned theIndex, NSPoint thePoint, unsigned int theFlags, id sender) {
...
BOOL NSInputServer_mouseDraggedOnCharacterIndex_atCoordinate_withModifier_client (NSInputServer* THIS, unsigned theIndex, NSPoint thePoint, unsigned int theFlags, id sender) {
...
void NSInputServer_mouseUpOnCharacterIndex_atCoordinate_withModifier_client (NSInputServer* THIS, unsigned theIndex, NSPoint thePoint, unsigned int theFlags, id sender) {
