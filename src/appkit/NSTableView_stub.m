...
void NSTableView_setDataSource (NSTableView* THIS, id aSource) {
...
void NSTableView_setDelegate (NSTableView* THIS, id delegate) {
...
int NSTableView_columnWithIdentifier (NSTableView* THIS, id identifier) {
	NSLog(@"NSTableView_columnWithIdentifier");
	return [THIS columnWithIdentifier:identifier];
}

NSTableColumn * NSTableView_tableColumnWithIdentifier (NSTableView* THIS, id identifier) {
...
void NSTableView_selectAll (NSTableView* THIS, id sender) {
	NSLog(@"NSTableView_selectAll");
	[THIS selectAll:sender];
}

void NSTableView_deselectAll (NSTableView* THIS, id sender) {
...
void NSTableView_tableView_willDisplayCell_forTableColumn_row (NSTableView* THIS, NSTableView * tableView, id cell, NSTableColumn * tableColumn, int row) {
...
void NSTableView_tableView_setObjectValue_forTableColumn_row (NSTableView* THIS, NSTableView * tableView, id object, NSTableColumn * tableColumn, int row) {
