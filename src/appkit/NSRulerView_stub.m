...
void NSRulerView_registerUnitWithName_abbreviation_unitToPointsConversionFactor_stepUpCycle_stepDownCycle (NSRulerView* THIS, NSString * unitName, NSString * abbreviation, float conversionFactor, NSArray * stepUpCycle, NSArray * stepDownCycle) {
	NSLog(@"NSRulerView_registerUnitWithName_abbreviation_unitToPointsConversionFactor_stepUpCycle_stepDownCycle");
	[THIS registerUnitWithName:unitName abbreviation:abbreviation unitToPointsConversionFactor:conversionFactor stepUpCycle:stepUpCycle stepDownCycle:stepDownCycle];
}
