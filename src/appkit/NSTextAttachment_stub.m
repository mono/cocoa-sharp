...
NSAttributedString * NSTextAttachment_attributedStringWithAttachment (NSTextAttachment* THIS, NSTextAttachment * attachment) {
	NSLog(@"NSTextAttachment_attributedStringWithAttachment");
	return [THIS attributedStringWithAttachment:attachment];
}
