...
NSWindowController * NSWindowController_initWithWindowNibName_owner (NSWindowController* THIS, NSString * windowNibName, id owner) {
	NSLog(@"NSWindowController_initWithWindowNibName_owner");
	return [THIS initWithWindowNibName:windowNibName owner:owner];
}

NSWindowController * NSWindowController_initWithWindowNibPath_owner (NSWindowController* THIS, NSString * windowNibPath, id owner) {
...
IBAction NSWindowController_showWindow (NSWindowController* THIS, id sender) {
