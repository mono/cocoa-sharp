...
//
// $Id: OutputElement.cs,v 1.3 2004/09/11 00:41:22 urs Exp $
//
...
namespace CocoaSharp {
	public abstract class OutputElement {
		...
		internal static TextWriter OpenFile(string pathFormat,string nameSpace,string fileFormat,string file) {
